export const RECIPE = {
    title: 'Recipe for Banana Nut Bread',
    imgSrc: require('../assets/Best-Banana-Nut-Bread-Recipe.jpg'),
    description:
        'A simple short recipe for making banana nut bread',
    ingredients: [
    ...
    instructions: [
        ...
        'Gradually pour the egg mixture into the butter while mixing until incorporated. Add the bananas (the mixture will appear to be curdled, so dont worry) , and remove the bowl from the mixer',
        ...
        'Turn the bread out of the pan and let cool completely on the rack. Wrap in plastic wrap.'
